<?php $this->layout('email.user::/layout', ['title' => 'Reset Password', 'siteUrl' => $siteUrl, 'logo' => $logo, 'address' => $address, 'unsubscribe' => null]) ?>
<tr>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td align="center" style="font-size: 25px; font-family: Helvetica, Arial, sans-serif; color: #333333; padding-top: 30px;" class="padding">Confirm your change of email address.</td>
                                    </tr>
                                    <tr>
                                        <td align="center" style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding">Your email was changed on <?= $siteUrl ?>. Click the button below to confirm the change.</td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
